...
The 6 digit numbers you see in front of trees are **mode**s (we mentioned above) which specifies what kind of file is it and what permissions does it have. The first two digits are file type and last tree digits are UNIX permissions. Read more about modes [here](https://stackoverflow.com/questions/737673/how-to-read-the-mode-field-of-git-ls-trees-output).
